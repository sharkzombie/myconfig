...
(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (my-bold ((t (:bold t :weight extra-bold))))
     (my-condition ((t (:background "#CB98E699EAF9" :strike-through nil))))
     (my-consequent ((t (:background "#E544E5E5D570"))))
     (my-otherwise ((t (:background "#DAFDDB96CBDD"))))
